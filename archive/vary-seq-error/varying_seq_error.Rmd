...
saveRDS(high_names, here::here("metadata", "high_coi_names.rds"))
saveRDS(low_names, here::here("metadata", "low_coi_names.rds"))
```
...
```{r final predictions}
readRDS(here::here("data-outputs", "freq_variation.rds"))
```
