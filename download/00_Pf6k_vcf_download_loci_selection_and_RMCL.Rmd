...
of P. falciparum malaria ][https://elifesciences.org/articles/40845]. We'll save
these in share as this filter will be used a lot in the future for isolating
SNPs for Fst between countries etc, so we can start from Zhu.
