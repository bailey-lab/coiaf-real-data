...
bcf_filter <- function(x,
                       dir = "/gpfs/data/jbailey5/apascha1/pf_release6/") {
  if (x < 10) {
    x <- paste0("0", x)
  }
...
intersect_snps <- readRDS(paste0(home_dir, "derived/intercept_snps_0.01.rds"))
...
vcf_rds <- paste0(home_dir, "derived/vcf_final.rds")
...
gen_rds <- paste0(home_dir, "derived/gen.rds")
saveRDS(gen, gen_rds)
